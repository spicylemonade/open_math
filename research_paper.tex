...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \caption{Example multi-body trajectory from the random cluster
    simulation, illustrating the complex gravitational scattering
    dynamics captured by the simulator.}
  ...
  Right: a multi-body cluster showing chaotic gravitational interactions.}
